...
We used the R package pavo (Maia et al., 2019) to compute chromatic and achromatic contrasts.
We extracted the chromatic and achromatic contrasts between each pair of species in the dataset, comparing only analogous spots (i.e.
